...
- (void)vuforiaManager:(VuforiaManager *)manager didGetObject:(NSString*)name withPosition:(SCNMatrix4)swiftMatrix;
- (void)vuforiaManager:(VuforiaManager *)manager finishedSendingObjects:(bool)finished;
